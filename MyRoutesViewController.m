...
-(void)loadUser{
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 480) //iPhone 4S size
    {
        Button1.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 568) //iPhone 5 size
    {
        Button1.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button1.frame = CGRectMake(0, 130, self.view.frame.size.width/2, 260);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
    {
        Button1.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    [Button1 setBackgroundImage:[UIImage imageNamed:@"btn1"] forState:UIControlStateNormal];
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 480) //iPhone 4S size
    {
        Button2.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 568) //iPhone 5 size
    {
        Button2.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button2.frame = CGRectMake(self.view.frame.size.width/2, 130, self.view.frame.size.width/2, 260);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
    {
        Button2.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button2.frame = CGRectMake(0, 80, self.view.frame.size.width, 80);
    } else {
        Button2.frame = CGRectMake(0, 80, self.view.frame.size.width, 80);
    }
    [Button2 setBackgroundImage:[UIImage imageNamed:@"btn2"] forState:UIControlStateNormal];
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 480) //iPhone 4S size
    {
        Button3.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 568) //iPhone 5 size
    {
        Button3.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button3.frame = CGRectMake(0, 390, self.view.frame.size.width/2, 260);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
    {
        Button3.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button3.frame = CGRectMake(0, 80, self.view.frame.size.width, 80);
    } else {
        Button3.frame = CGRectMake(0, 80, self.view.frame.size.width, 80);
    }
    [Button3 setBackgroundImage:[UIImage imageNamed:@"btn3"] forState:UIControlStateNormal];
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 480) //iPhone 4S size
    {
        Button4.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 568) //iPhone 5 size
    {
        Button4.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button4.frame = CGRectMake(self.view.frame.size.width/2, 390, self.view.frame.size.width/2, 260);
    }
    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
    {
        Button4.frame = CGRectMake(0, 60, self.view.frame.size.width, 80);
    ...
    {
        Button4.frame = CGRectMake(0, 80, self.view.frame.size.width, 80);
    } else {
        Button4.frame = CGRectMake(0, 80, self.view.frame.size.width, 80);
    }
    [Button4 setBackgroundImage:[UIImage imageNamed:@"btn4"] forState:UIControlStateNormal];
